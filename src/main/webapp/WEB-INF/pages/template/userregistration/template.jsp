...
<head>
    ...
    <%--<!--bootstrap dialog-->--%>
    <%--<script src="${pageContext.request.contextPath}/resources/js/bootstrapDialog/bootstrap-dialog.min.js?${initParam['version']}"--%>
    <%--type="text/javascript"></script>--%>
    ...
    <%--<!--bootstrap dialog-->--%>
    <%--<link href="${pageContext.request.contextPath}/resources/css/bootstrapDialog/bootstrap-dialog.min.css?${initParam['version']}"--%>
    <%--rel="stylesheet" type="text/css"/>--%>
