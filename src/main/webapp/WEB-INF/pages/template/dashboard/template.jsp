...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css"
    ...
    <style>
        ...
        .SCSC {
            ...
            background-image: url(${pageContext.request.contextPath}/resources/assets/media/svg/sidebar/settings.svg)
        }

        .SYAU {
            background-color: #0a66ac !important;
            background-image: url(${pageContext.request.contextPath}/resources/assets/media/svg/sidebar/delivery-box.svg)
        }

        .REEX {
            background-color: #6cb6ef !important;
            background-image: url(${pageContext.request.contextPath}/resources/assets/media/svg/sidebar/analysis.svg)
        }

        .SMSS {
            background-color: #2f67a0 !important;
            background-image: url(${pageContext.request.contextPath}/resources/assets/media/svg/sidebar/chat.svg)
        }

        .ATLM {
            background-color: #34495e !important;
            background-image: url(${pageContext.request.contextPath}/resources/assets/media/svg/sidebar/signal.svg)
        }

        .UMSC {
            background-color: #00BCD4 !important;
            background-image: url(${pageContext.request.contextPath}/resources/assets/media/svg/sidebar/manager.svg)
        }
    </style>
...
<!--begin::Main-->
<!--begin::Header Mobile-->
<tiles:insertAttribute name="header_mob"/>
<!--end::Header Mobile-->
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between">
        <h3 class="font-weight-bold m-0">User Detail
        </h3>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
								...
								<span class="navi-icon mr-1">
									<span class="svg-icon svg-icon-lg svg-icon-primary">
										...
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19.4167 10.9399V6.33335C19.4167 5.32225 18.5944 4.5 17.5833 4.5H3.8333C2.82221 4.5 2 5.32221 2 6.33335V15.5C2 16.5111 2.82221 17.3333 3.83335 17.3333H14.1121C14.7126 19.4462 16.6555 21 18.9583 21C19.8446 21 20.716 20.7668 21.4796 20.325C21.6985 20.1984 21.7737 19.9182 21.6466 19.6989C21.5199 19.4796 21.2393 19.4039 21.0204 19.5319C20.3964 19.8927 19.6834 20.0833 18.9583 20.0833C16.6836 20.0833 14.8333 18.233 14.8333 15.9583C14.8333 13.6837 16.6837 11.8333 18.9583 11.8333C21.2329 11.8333 23.0833 13.6837 23.0833 15.9583V16.4167C23.0833 16.922 22.672 17.3333 22.1667 17.3333C21.6613 17.3333 21.25 16.922 21.25 16.4167V14.5833C21.25 14.33 21.045 14.125 20.7917 14.125C20.6684 14.125 20.5576 14.1749 20.4753 14.2539C20.0702 13.8929 19.5423 13.6667 18.9583 13.6667C17.6948 13.6667 16.6667 14.6948 16.6667 15.9583C16.6667 17.2218 17.6948 18.25 18.9583 18.25C19.6414 18.25 20.2487 17.9436 20.6689 17.4679C21.001 17.9396 21.5472 18.25 22.1667 18.25C23.1778 18.25 24 17.4278 24 16.4167V15.9583C24 13.333 21.9824 11.1725 19.4167 10.9399ZM3.83335 5.41665H17.5833C17.6024 5.41665 17.6184 5.42641 17.6372 5.42757L11.0852 10.8057C10.852 10.9525 10.5141 10.922 10.3624 10.829L3.78002 5.42748C3.79863 5.42636 3.81444 5.41665 3.83335 5.41665ZM18.5 10.9399C15.9343 11.1725 13.9167 13.333 13.9167 15.9583C13.9167 16.113 13.9261 16.2655 13.9399 16.4167H3.83335C3.32804 16.4167 2.9167 16.0054 2.9167 15.5V6.33335C2.9167 6.20354 2.94536 6.08095 2.99425 5.96897L9.82126 11.5675C10.088 11.7416 10.3946 11.8334 10.7084 11.8334C11.0101 11.8334 11.305 11.7484 11.5646 11.5872C11.5906 11.5733 11.6152 11.5568 11.6385 11.5376L18.4224 5.96889C18.4713 6.08095 18.5 6.20354 18.5 6.33339V10.9399H18.5ZM18.9583 17.3333C18.2001 17.3333 17.5833 16.7166 17.5833 15.9583C17.5833 15.2001 18.2001 14.5833 18.9583 14.5833C19.7166 14.5833 20.3333 15.2001 20.3333 15.9583C20.3333 16.7166 19.7166 17.3333 18.9583 17.3333Z" fill="black"/>
                                        </svg>
                    ...
                    <a href="${pageContext.request.contextPath}/logout.htm?error=0"
                       class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" id="sign_out_dash">Sign Out</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
            ...
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                ...
                <div class="mb-15">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
									<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/006-plurk.svg"
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
									<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/015-telegram.svg"
                                         class="h-50 align-self-center"
                                         alt=""/>
								</span>
                        </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
									<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/003-puzzle.svg"
                                         class="h-50 align-self-center"
                                         alt=""/>
								</span>
                        </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
									<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/005-bebo.svg"
                                         class="h-50 align-self-center"
                                         alt=""/>
								</span>
                        </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
									<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/014-kickstarter.svg"
                                         class="h-50 align-self-center"
                                         alt=""/>
								</span>
                        </div>
