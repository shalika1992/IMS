...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        <!--begin::Aside-->
        <div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url(${pageContext.request.contextPath}/resources/assets/media/bg/bg-login.jpg);">
            <!--begin: Aside Container-->
            <div class="d-flex flex-row-fluid flex-column justify-content-between">
                <!--begin: Aside header-->
                <a href="#" class="flex-column-auto mt-5 pb-lg-0 pb-10">
                    <img src="${pageContext.request.contextPath}/resources/assets/media/logos/combanklogo1.svg" class="max-h-70px" alt="" />
                </a>
                <!--end: Aside header-->
                <!--begin: Aside content-->
                <div class="flex-column-fluid d-flex flex-column justify-content-center">
                    <h3 class="font-size-h1 mb-5 text-white text-combank">Commercial Bank SMS</h3>
                    <p class="font-weight-lighter text-white opacity-80">Having set a benchmark in banking in Sri Lanka we have set standards, created an identity and forged an unsurpassable trend. Recognised as a trend setter, we have maintained our cultural identity while providing a range of products and services. Powered by state-of-the-art technology and driven by a team of highly motivated, dynamic individuals we have become the leader in private banking in Sri Lanka.</p>
                </div>
                <!--end: Aside content-->
